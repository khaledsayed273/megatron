...
function EmailComponent({baseUrl}) {
    ...
    return (
        <div data-aos="fade-up" data-aos-duration="1000" className='container mx-auto p-5 my-7'>
            <div  className='h-[400px] relative overflow-hidden rounded-3xl'>
                <Image style={{objectFit: "cover"}} placeholder='blur' sizes='(max-width:992px) , 100vw' src={img} fill alt='bgImage'/>
                <div className='flex justify-center items-center z-50 flex-col absolute left-0 top-0 w-full h-full px-5'>
                    ...
                    <div>
                        <h2 className='text-center text-white text-xl md:text-3xl my-3'>Do cool things with us.</h2>
