...
async function page({ params }) {
    ...
    return (
        <div className='container mx-auto px-3'>
            ...
            <p className='text-center text-white/70 text-xs md:text-sm mb-10 md:mb-16'>Explore our captivating blog filled with thought-provoking articles and inspiring content that will ignite your creativity and expand your knowledge.</p>
