...
function page() {
    ...
    return (
        <div className='container mx-auto px-3'>
            <h1 data-aos="fade-right" data-aos-duration="1000" className='text-center text-white text-xl md:text-4xl capitalize mb-3'>discover our projects</h1>
            <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-white text-xs md:text-sm'>explore our captivating blog filled with thought-provoking articles and inspiring content that will ignite your creativity and expand your knowledge.</p>
