    ...
    <main className="container mx-auto px-5 my-10">
      ...
      <div data-aos="fade-right"
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <span data-aos="fade-right" data-aos-duration="1000" className='btnOrange text-white capitalize font-bold px-6 py-1 rounded-full'>our story</span>
            <p data-aos="fade-right" data-aos-duration="1000" className='mt-5 mb-7 text-sm'>In 2010, our founder, Vasily, faced a daunting challenge - preparing for the Law School Admission Test (LSAT) while juggling an internship and evening classes in different cities. The lack of time and a conducive study environment made it incredibly difficult for him to achieve his dream of becoming a lawyer.</p>
            <p data-aos="fade-right" data-aos-duration="1000" className='text-sm'>During a train ride, a moment of inspiration struck Vasily. He wished for a convenient study tool on his phone to help him prepare for the LSAT. However, such an app didn&apos;t exist at the time. Determined to overcome this hurdle, Vasily took matters into his own hands and developed one of the earliest and most comprehensive LSAT apps on the market. The app quickly gained popularity, becoming the #1 paid LSAT app for over a year.</p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-10">
          <div data-aos="fade-right" data-aos-duration="1000" className='flex justify-center items-center order-2 md:order-1'>
            <div className='relative h-[300px] xl:h-full w-full xl:w-9/12  overflow-hidden rounded-3xl md:rounded-ss-[170px] md:rounded-ee-[170px]'>
              <Image priority sizes='(min-width:992px) , 100vw' fill src={secoundImageAboutUs} alt='secoundImageAboutUs' />
            </div>
          </div>
          <div  className='order-1 md:order-2'>
            <p data-aos="fade-right" data-aos-duration="1000" className='mt-5 mb-7 text-sm'>This success prompted Vasily to establish FutureSphere, an app development company with a strong focus on creating profitable and impactful applications. Building on their initial achievement, FutureSphere expanded their educational app portfolio to include exams such as SAT, GMAT, MCAT, and more, catering to the needs of a broader audience.</p>
            <p data-aos="fade-right" data-aos-duration="1000" className='text-sm'>As time went on, it became evident that the industry had much more to offer than just exam-focused applications. People began approaching FutureSphere, seeking guidance on how to develop their own apps, what it takes to succeed, and how to navigate the complex world of mobile applications. In response to this growing demand for expertise and support, FutureSphere expanded its services and evolved into a comprehensive resource for aspiring app creators - a company known as FutureSphere.</p>
          </div>
        </div>
      </div>
      ...
      <div data-aos="fade-right" data-aos-duration="1000">
        <div className='flex justify-center flex-col items-center'>
          <span data-aos="fade-right" data-aos-duration="1000" className='text-white btnOrange capitalize px-6 py-1 font-bold rounded-full'>our values</span>
          <h2 data-aos="fade-right" data-aos-duration="1000" className='capitalize mt-6 text-white text-xl md:text-4xl'>guided by integrity and purpose</h2>
          <p data-aos="fade-right" data-aos-duration="1000" className='text-white text-sm md:text-base mt-5 text-center md:px-10 xl:px-32'>At FutureSphere, we are driven by a strong set of values that shape every aspect of our business, ensuring transparency, ethical practices, and a shared commitment to making a positive impact.</p>
        </div>
        <div className='bg-white p-7 mt-10 rounded-xl'>
          <div className="flex flex-col md:flex-row items-center justify-center">
            <div data-aos="fade-right" data-aos-duration="1000" className='flex flex-col items-center justify-center my-5'>
              ...
              <span data-aos="fade-right" data-aos-duration="1000" className='mt-3 mb-4 font-bold'>Integrity</span>
              <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-sm md:px-10'>Upholding honesty and ethical conduct in everything we do, building trust with our stakeholders.</p>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" className='flex flex-col items-center justify-center my-5'>
              <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span data-aos="fade-right" data-aos-duration="1000" className='mt-3 mb-4 font-bold'>Innovation</span>
              <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-sm md:px-10'>Embracing a culture of creativity and continuous improvement to drive groundbreaking solutions.</p>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" className='flex flex-col items-center justify-center my-5'>
              <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span data-aos="fade-right" data-aos-duration="1000" className='mt-3 mb-4 font-bold'>Collaboration</span>
              <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-sm md:px-10'>Fostering a collaborative environment that encourages teamwork, diversity, and shared success.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:mt-20">
            <div data-aos="fade-right" data-aos-duration="1000" className='flex flex-col items-center justify-center my-5'>
              ...
              <span data-aos="fade-right" data-aos-duration="1000" className='mt-3 mb-4 font-bold'>Customer-centric</span>
              <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-sm md:px-10'>Putting our customers at the heart of everything we do, delivering exceptional experiences and exceeding their expectations.</p>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" className='flex flex-col items-center justify-center my-5'>
              ...
              <span data-aos="fade-right" data-aos-duration="1000" className='mt-3 mb-4 font-bold'>Sustainability</span>
              <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-sm md:px-10'>Operating with a focus on environmental and social responsibility, striving for a more sustainable future.</p>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" className='flex flex-col items-center justify-center my-5'>
              <svg  width="39" height="36" viewBox="0 0 39 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span data-aos="fade-right" data-aos-duration="1000" className='mt-3 mb-4 font-bold'>Excellence</span>
              <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-sm md:px-10'>Pursuing excellence in all aspects of our work, setting high standards and striving for continuous growth and improvement.</p>
            </div>
          </div>
        </div>
      </div>

      <div data-aos="fade-right" data-aos-duration="1000" className='my-7'>
      ...
      <div className='my-10'>
        ...
        <h1 data-aos="fade-right" data-aos-duration="1000" className='text-xl lg:text-4xl font-bold text-white capitalize text-center'>Discover Our Global Network of Offices</h1>
        <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-white text-xs md:text-sm my-5'>Experience our expansive network of offices across the world, connecting you to our exceptional services wherever you are.</p>
        <div data-aos="fade-right" data-aos-duration="1000" className='bg-white p-7  grid md:grid-cols-2 lg:grid-cols-3 gap-5 rounded-xl'>
          {data2.map((item) => (
            <div data-aos="fade-right" data-aos-duration="1000" key={item.id} className='xl:px-5'>
      ...
      <div data-aos="fade-right" data-aos-duration="1000" className='flex justify-center items-center mt-5 mb-10'>
        <Link className='px-4 sm:px-6 py-1.5 text-white rounded-full font-bold capitalize btnOrange' href={"/contactUs"}>contact us</Link>
      </div>
    </main>
  )
