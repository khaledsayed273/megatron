...
async function page({ params: { lang } }) {
  ...
  return (
    <main className="container mx-auto px-5 my-10">
      ...
      <div className='bg-white py-10 px-5 my-12 rounded-3xl'>
      ...
      <div>
        <div className='flex justify-center flex-col items-center'>
          <span className='text-white btnOrange capitalize px-6 py-1 font-bold rounded-full'>our values</span>
          <h2 className='capitalize mt-6 text-white text-xl md:text-4xl'>guided by integrity and purpose</h2>
          <p className='text-white text-sm md:text-base mt-5 text-center md:px-10 xl:px-32'>At FutureSphere, we are driven by a strong set of values that shape every aspect of our business, ensuring transparency, ethical practices, and a shared commitment to making a positive impact.</p>
        </div>
        <div className='bg-white p-7 mt-10 rounded-xl'>
          <div className="flex flex-col md:flex-row items-center justify-center">
            <div className='flex flex-col items-center justify-center my-5'>
              ...
              <span className='mt-3 mb-4 font-bold'>Integrity</span>
              <p className='text-center text-sm md:px-10'>Upholding honesty and ethical conduct in everything we do, building trust with our stakeholders.</p>
            </div>
            <div className='flex flex-col items-center justify-center my-5'>
              <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className='mt-3 mb-4 font-bold'>Innovation</span>
              <p className='text-center text-sm md:px-10'>Embracing a culture of creativity and continuous improvement to drive groundbreaking solutions.</p>
            </div>
            <div className='flex flex-col items-center justify-center my-5'>
              <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className='mt-3 mb-4 font-bold'>Collaboration</span>
              <p className='text-center text-sm md:px-10'>Fostering a collaborative environment that encourages teamwork, diversity, and shared success.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:mt-20">
            <div className='flex flex-col items-center justify-center my-5'>
              ...
              <span className='mt-3 mb-4 font-bold'>Customer-centric</span>
              <p className='text-center text-sm md:px-10'>Putting our customers at the heart of everything we do, delivering exceptional experiences and exceeding their expectations.</p>
            </div>
            <div className='flex flex-col items-center justify-center my-5'>
              ...
              <span className='mt-3 mb-4 font-bold'>Sustainability</span>
              <p className='text-center text-sm md:px-10'>Operating with a focus on environmental and social responsibility, striving for a more sustainable future.</p>
            </div>
            <div className='flex flex-col items-center justify-center my-5'>
              <svg width="39" height="36" viewBox="0 0 39 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className='mt-3 mb-4 font-bold'>Excellence</span>
              <p className='text-center text-sm md:px-10'>Pursuing excellence in all aspects of our work, setting high standards and striving for continuous growth and improvement.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='my-10'>
        ...
        <h1 className='text-xl lg:text-4xl font-bold text-white capitalize text-center'>Discover Our Global Network of Offices</h1>
        <p className='text-center text-white text-xs md:text-sm my-5'>Experience our expansive network of offices across the world, connecting you to our exceptional services wherever you are.</p>
        <div className='bg-white p-7  grid md:grid-cols-2 lg:grid-cols-3 gap-5 rounded-xl'>
          {data2.map((item) => (
