            ...
            {data.status ? (
                <>
                    <div className="grid md:grid-cols-2 gap-10">
                        <div data-aos-duration="1000" data-aos="fade-right" className='relative h-[200px] md:h-[300px] w-full xl:w-5/6 mx-auto rounded-ss-[100px]  md:rounded-ss-[200px] rounded-ee-[100px] md:rounded-ee-[200px] overflow-hidden'>
                    ...
                    <div data-aos-duration="1000" data-aos="fade-right" className='lg:w-9/12 border mx-auto mt-10 p-8 md:p-10 rounded-2xl'>
                        <span data-aos-duration="1200" data-aos="fade-right" className='uppercase text-amber-500 font-bold'>our work</span>
                        <p data-aos-duration="1200" data-aos="fade-right" className='text-xs md:text-sm mt-5 text-white'>To excel in the role of Product Manager, the following education and experience are typically required:</p>
                        <ol data-aos-duration="1200" data-aos="fade-right" className='list-disc md:ms-5 mt-3 text-xs md:text-sm'>
                        ...
                        <span data-aos-duration="1200" data-aos="fade-right" className='capitalize mt-7 inline-block text-amber-600 font-semibold'>technical skills</span>
                        <p data-aos-duration="1200" data-aos="fade-right" className='text-xs md:text-sm mt-5 text-white'>As a Product Manager, you should possess the following technical skills:</p>
                        <ol data-aos-duration="1200" data-aos="fade-right" className='list-disc md:ms-5 mt-3 text-xs md:text-sm'>
                        ...
                        <span data-aos-duration="1200" data-aos="fade-right" className='capitalize mt-7 inline-block text-amber-600 font-semibold'>core competencies</span>
                        <p data-aos-duration="1200" data-aos="fade-right" className='text-xs md:text-sm mt-5 text-white'>The successful candidate should demonstrate the following core competencies:</p>
                        <ol data-aos-duration="1200" data-aos="fade-right" className='list-disc md:ms-5 mt-3 text-xs md:text-sm'>
                    ...
                    <div data-aos-duration="1000" data-aos="fade-right" className='border text-white py-10 px-5 my-12 rounded-3xl'>
                        <div data-aos-duration="1200" data-aos="fade-right" className="grid md:grid-cols-2 gap-12">
                        ...
                        <div data-aos-duration="1200" data-aos="fade-right" className="grid md:grid-cols-2 gap-12 mt-10">
