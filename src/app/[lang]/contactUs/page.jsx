...
function page() {
  ...
  return (
    ...
    <div  className='container mx-auto mt-5 px-3'>
      ...
      <h1 data-aos="fade-right" data-aos-duration="1000"  className='text-center text-white text-xl md:text-4xl capitalize mb-3'>contact us</h1>
      <p data-aos="fade-right" data-aos-duration="1000" className='text-center text-white text-xs md:text-sm'>At FutureSphere our mission is to empower individuals and businesses through innovative technology solutions that enrich lives, foster growth, and drive positive change.</p>
        ...
        <div className='xl:col-span-2  '>
          ...
          <div  data-aos="fade-right" className='bg-white rounded-xl   my-7'>
            <div className="grid lg:grid-cols-3 p-5  gap-7">
              <div data-aos="fade-right" data-aos-duration="1000" className='flex flex-col items-center justify-center'>
      ...
      <div data-aos="fade-right" className='my-8'>
        ...
        <h3 data-aos="fade-right" data-aos-duration="1000" className='text-white text-center capitalize mt-7 text-xl md:text-3xl'>discover our global network of offices</h3>
        <p data-aos="fade-right" data-aos-duration="1000" className='text-white text-center capitalize text-xs md:text-sm mt-5'>experience our expansive network of offices across the world, connecting you to our exceptional services wherever you are.</p>
      ...
      <div data-aos="fade-right" className="my-16">
        ...
        <h3 data-aos="fade-right" data-aos-duration="1000" className='text-white text-center capitalize mt-7 text-xl md:text-3xl'>answers to some of your questions</h3>
        <p data-aos="fade-right" data-aos-duration="1000" className='text-white text-center capitalize text-xs md:text-sm mt-5'>Don’t find the answers you were looking for? Contact us at <span className='text-amber-600 mt-2 inline-block'>futuresphere@gmail.com</span></p>
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          <div data-aos="fade-right" data-aos-duration="1000" className="bg-white p-5 md:p-7 rounded-xl">
        ...
        <div data-aos="fade-right" data-aos-duration="1000" className="grid md:grid-cols-2 gap-10 mt-10">
          <div data-aos="fade-right" data-aos-duration="1000" className="bg-white p-5 md:p-7 rounded-xl">
