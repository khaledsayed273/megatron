  ...
  return (
    <main className='container mx-auto mt-5 px-3'>
          ...
          <div data-aos="fade-up" className='bg-white rounded-xl my-7'>
            <div className="grid lg:grid-cols-3 p-5  gap-7">
              <div data-aos="fade-up" data-aos-duration="1000" className='flex flex-col items-center justify-center'>
                ...
                <Link href={"mailto:contact@megatron-soft.com"} className='text-sm mt-1'>Contact@megatron-soft.com</Link>
              </div>
              <div data-aos="fade-up" data-aos-duration="1000" className='flex flex-col items-center justify-center'>
                <svg width="46" height="38" viewBox="0 0 46 38" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div data-aos="fade-up" data-aos-duration="1000" className='flex flex-col items-center justify-center'>
                ...
                <Link href={"mailto:Support@megatron-soft.com"} className='text-sm mt-1'>Support@megatron-soft.com</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <div data-aos="fade-up" className="my-16">
        ...
        <p data-aos="fade-up" data-aos-duration="1000" className='text-white text-center capitalize text-xs md:text-sm mt-5'>Don’t find the answers you were looking for? Contact us at <Link href={"mailto:contact@megatron-soft.com"} className='text-amber-500 normal-case underline font-semibold mt-2 inline-block'>contact@megatron-soft.com</Link></p>
